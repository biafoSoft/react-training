      ...
      <div className="navbar-start">
        <div className="dropdown">
          ...
          <ul
            ...
            <li><a href="/">Latest Bags</a></li>
          </ul>
        </div>
        <a className="text-2xl font-bold cursor-pointer text-green-700 hover:text-green-600">AwosomeShop</a>
      </div>
            ...
            <div className="dropdown dropdown-end">
              <div tabIndex={0} role="button" className="btn btn-ghost btn-circle">
                <div className="indicator">
                  ...
                  <span className="badge badge-sm indicator-item bg-green-400">{itemCount}</span>
                </div>
              </div>
              <div
                tabIndex={0}
